...
func Setup(app *fiber.App) {
	...
	ambassadors.Get("/products/frontend", controllers.ProductsFrontend)
	ambassadors.Get("/products/backend", controllers.ProductsBackend)
	...
	checkout.Post("/order/place", controllers.PlaceOrder)
}
